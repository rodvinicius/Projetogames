create database bd1_games default character set utf8 collate utf8_general_ci;
use bd1_games;
-- drop database bd1_games;
...
select * from generos;
delete from produtoras where cod = 18;
...
('admin3', 'vini2', '$2y$10$0i/oL0eIDxTg9VymFH8kFuElS0Oi.CBDj8B4yuhG/AHi2dhLBdWj.', 'admin');


select j.cod, j.nome, j.capa, g.genero from jogos j 
join generos g on j.genero=g.cod;

SELECT j.cod, j.nome, g.genero, p.produtora, j.descricao, j.nota,j.capa, p.pais FROM jogos j
JOIN generos g ON j.genero=g.cod 
